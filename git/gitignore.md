...
일반적으로 개발 환경에서 자주 설정하는 내용은 [gitignore.id](https://gitignore.io) 에서 가져오는 것을 추천한다.

* `pyhton`, `windows`, `jupyternotebook` 
...
# End of https://www.gitignore.io/api/python,windows,jupyternotebook
```
